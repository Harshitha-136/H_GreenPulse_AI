...
from GreenPulse_AI.solar_data import get_monthly_solar_generation, get_karnataka_sldc_solar_data

app = Flask(__name__, template_folder='GreenPulse_AI/templates', static_folder='GreenPulse_AI/static')
CORS(app)

BASE_DIR = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'GreenPulse_AI')
...
def chat():
    ...
    if not message:
        return jsonify({'type': 'answer', 'content': 'Please send a message.'})
